window.NORD_POSTS = [
  {
    ...
    body: [
      ...
      { h: '2026\'da iki şey aynı anda değişti', p: [
      ...
      { h: 'Kadro bazlı teşvikler: en çok kaçırılan grup', p: [
        ...
        'Genç ve kadın istihdamı teşviki — son altı aydır işsiz olan, on sekiz yaşından büyük bir kadını ya da genci ortalama sigortalı sayısına ilave olarak işe aldığınızda, mesleki yeterlilik belgesi durumuna göre altı ilâ elli dört ay boyunca işveren primi desteklenir',
        'İşsizlik ödeneği alanların istihdamı — işsizlik ödeneği almakta olan bir sigortalıyı işe aldığınızda, ödeneğe hak kazandığı süre boyunca uzun vadeli sigorta primleri ile genel sağlık sigortası priminin tamamı İşsizlik Sigortası Fonu\'ndan karşılanır',
        'Asgari ücret desteği — şartları sağlayan işyerlerinde 2026 boyunca, prim ödeme gün sayısı ile günlük destek tutarının çarpımı kadar tutar ödenecek primlerden mahsup edilir',
        'Engelli sigortalı teşviki — kontenjan dahilinde ve kontenjan fazlası engelli çalışan için işveren prim hissesinde destek uygulanır',
        'Ar-Ge ve tasarım personeli desteği — 5746 sayılı Kanun kapsamındaki personel için sigorta primi işveren hissesinin yarısı bütçeden karşılanır'
      ]},
      { h: 'Yazılım geliştiren finans şirketi iki teşvik alanının kesişiminde', p: [
      ...
      { h: 'Yararlanmanın önkoşulları basit ama affetmiyor', p: [
      ...
      { h: 'Teşvik takibi bordronun içinde olmalı', p: [
  ...
  },
  {
    ...
    body: [
      ...
      { h: 'Yönetim yükü bir maliyet kalemidir', p: [
        'Orta ölçekli bir kurum bordro, filo, yakıt, yemek kartı, grup sağlık poliçesi, İSG, seyahat ve işe alım için ortalama yedi ilâ on bir ayrı tedarikçiyle çalışır. Bu tedarikçilerin her biri ayrı bir sözleşme, ayrı bir muhatap, ayrı bir fatura ve ayrı bir mutabakat demektir.',
        'Bir mutabakatın ortalama süresi kalem sayısına göre değişir; ancak dokuz tedarikçili bir yapıda muhasebe ekibinin ay sonu kapanışına yalnızca destek hizmetleri için ayırdığı süre, tek tedarikçili bir yapıya kıyasla belirgin biçimde uzundur. Bu süre bir gider satırında görünmez, ama bir maaş bordrosunda görünür.'
      ]},
      { h: 'Ölçek avantajını kim kullanıyor?', p: [
        'Kırk araçlık bir filo, kiralama şirketi için küçük bir portföydür. Aynı kırk araç, üç yüz araçlık bir havuzun parçası olduğunda farklı bir fiyat listesine tabi olur. Aynı mantık grup sağlık poliçesinde, yemek kartı komisyonunda ve otel anlaşmalarında da geçerlidir.',
        'Tek başına pazarlık eden bir kurum, kendi hacmiyle sınırlıdır. Konsolide bir yapı üzerinden alım yaptığında, kendi hacminin değil havuzun hacminin fiyatını alır. Aradaki fark, hizmet kalitesinden ödün vermeden doğan net tasarruftur.'
      ]},
      { h: 'Yenilenme takvimi kimsenin sorumluluğunda değilse', p: [
        'Sekiz ayrı sözleşmenin sekiz ayrı yenilenme tarihi vardır. Bu tarihlerin takibi genellikle kimsenin resmî görev tanımında yer almaz; idari işler ile satın alma arasında kalır.',
        'Sonuç tanıdıktır: otomatik yenilenen bir poliçe, pazarlık penceresi kaçırıldığı için bir önceki yılın koşullarıyla değil, tedarikçinin tek taraflı güncellediği koşullarla devam eder. Bu, faturada bir artış olarak görünür ama nedeni faturada yazmaz.'
      ]},
      { quote: 'Dağınık tedarikte fiyat pazarlığı yılda bir yapılır; konsolide tedarikte her ay yapılır.' },
      { h: 'Görünmeyeni nasıl ölçersiniz?', p: [
        'Basit bir egzersizle başlayın. Son on iki ayın destek hizmeti faturalarını tek bir tabloda toplayın ve her satırın yanına üç şey yazın: sözleşme yenileme tarihi, kurum içinde bu tedarikçiyi yöneten kişi ve o kalemin son on iki aydaki birim fiyat değişimi.',
        'Tablo tamamlandığında iki şey ortaya çıkar. Birincisi, aynı işi yapan mükerrer hizmetler; ikincisi, hiç kimsenin sahiplenmediği kalemler. Bu iki grup, tasarruf potansiyelinin büyük bölümünü barındırır.'
      ]},
      { h: 'Konsolidasyon bir satın alma kararı değil, bir yapı kararıdır', p: [
        'Tedarikçi sayısını azaltmak tek başına tasarruf getirmez; hangi kalemin hangi ölçekte alındığını, kimin sahiplendiğini ve hangi baz maliyetle karşılaştırıldığını bilmek getirir.',
        'Nord\'un modeli bu üç soruyu tek muhatapta birleştirir: altı hizmet ailesi, tek fatura, tek mutabakat ve devir öncesi baz maliyetle karşılaştırmalı çeyreklik gözden geçirme. Tasarruf oranı sözleşmeye yazılır; ölçüm yöntemi de.'
      ]}
    ]
  },
  {
    ...
    body: [
      ...
      { h: 'Sorumluluk devredilemez, operasyon devredilebilir', p: [
      ...
      { h: 'Denetime hazır olmak nedir?', p: [
        ...
        'Kayıt bütünlüğü — personel dosyaları, ücret bordroları ve özlük belgelerinin eksiksiz ve tutarlı olması',
        'Denetim izi — hangi kaydın ne zaman değiştirildiğinin geriye dönük izlenebilmesi',
        'Erişim kısıtı — ücret ve sağlık verisine yalnızca görevi gereği ihtiyaç duyanların erişebilmesi',
        'Süre uyumu — yasal bildirimlerin mevzuatta öngörülen süre içinde tamamlanmış olması',
        'Devir planı — hizmet ilişkisi sona erdiğinde verinin nasıl ve hangi formatta geri alınacağının tanımlı olması'
      ]},
      { h: 'Lisanslı personelin özlük hassasiyeti', p: [
      ...
      { h: 'Veri lokasyonu ve alt işleyenler', p: [
  ...
  },
  {
    ...
    body: [
      ...
      { h: 'Doğru soru: hangi personel, hangi projede, ne kadar?', p: [
      ...
      { h: 'Bordroyla teşvikin aynı yerde olması', p: [
  ...
  },
  {
    ...
    body: [
      ...
      { h: 'Aynı paket, farklı fiyat', p: [
        'Yan hak maliyetinin önemli bir bölümü paketin içeriğinden değil, altyapı ve komisyon yapısından gelir. Yemek kartı komisyon oranı, kart basım ve dağıtım bedeli, kullanılmayan bakiyenin işleyişi ve poliçe aracılık komisyonu bunların başında gelir.',
        'Bu kalemler hacme duyarlıdır. Yüz kişilik bir kurum tek başına pazarlık ettiğinde aldığı komisyon oranı, aynı kurumun bin kişilik bir havuzun parçası olarak aldığı orandan yüksektir. Çalışan açısından hiçbir şey değişmez.'
      ]},
      { h: 'Grup sağlık poliçesinde kapsam okuma', p: [
        'Poliçe karşılaştırmalarında prim tutarı tek başına yanıltıcıdır. Aynı prime sahip iki poliçe arasında muafiyet oranı, anlaşmalı kurum ağı ve doğum–diş gibi ek teminatlar bakımından belirgin farklar olabilir.',
        'Doğru karşılaştırma, prim ile birlikte beklenen kullanım profilinin de hesaba katıldığı bir karşılaştırmadır. Genç kadrolu bir teknoloji şirketiyle ortalama yaşı yüksek bir kurumun optimum poliçesi aynı değildir.'
      ]},
      { h: 'Kullanılmayan hakkın maliyeti', p: [
        'Bütçelenmiş ama kullanılmayan yan hak, hem gider hem de kayıp algısı yaratır. Spor üyeliği, ulaşım desteği ya da esnek bütçe kalemlerinin kullanım oranı ölçülmediğinde, bütçe çalışanın değer vermediği bir kaleme akmaya devam eder.',
        'Kullanım verisinin düzenli izlenmesi, paketi küçültmeden yeniden dağıtmayı mümkün kılar: düşük kullanımlı kalem küçülür, yüksek talepli kalem büyür, toplam bütçe sabit kalır.'
      ]},
