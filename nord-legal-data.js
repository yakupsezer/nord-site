...
window.NORD_LEGAL = {
  kvkk: {
    ...
    sections: [{
      ...
      p: [`Kişisel verileriniz, veri sorumlusu sıfatıyla ${VS} ("Nord") tarafından, 6698 sayılı Kişisel Verilerin Korunması Kanunu ("KVKK") ve ilgili mevzuata uygun olarak işlenmektedir.`, `Adres: ${ADR}. İletişim: ${MAIL}.`]
    }, {
